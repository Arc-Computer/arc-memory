...
Usage:
    python quickstart.py [--file PATH] [--depth DEPTH] [--focus FOCUS]

Example:
    python quickstart.py --file src/core/auth.py --depth 3 --focus decisions
"""
...
class QuickstartDemo:
    """Quickstart Demo for Arc Memory."""

    def __init__(self):
        """Initialize the Quickstart Demo."""
        self.arc = None
        self.file_path = None
        self.depth = 2
        self.focus = "all"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Arc Memory Quickstart Demo")
    ...
    # Create and run the Quickstart Demo
    demo = QuickstartDemo()
